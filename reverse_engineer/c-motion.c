...
PMDCFunc PMDSetEventAction            (PMDAxisInterface axis_intf, PMDuint16  event, PMDuint16  action)
{
	return SendCommandWordWord(axis_intf, PMDOPSetEventAction, event, action);
}

PMDCFunc PMDGetEventAction            (PMDAxisInterface axis_intf, PMDuint16  event, PMDuint16* action)
{
	return SendCommandWordGetWord(axis_intf, PMDOPGetEventAction, event, action);
}
...
PMDCFunc PMDGetTemperature            (PMDAxisInterface axis_intf, PMDuint16* temperature)
{
	return SendCommandGetWord(axis_intf, PMDOPGetTemperature, temperature);
}
...
PMDCFunc PMDSetDriveCommandMode       (PMDAxisInterface axis_intf, PMDuint8 transport, PMDuint8 format)
{
	PMDuint16 value = (((PMDuint16)transport << 8) | format );
	return SendCommandWord(axis_intf, PMDOPSetDriveCommandMode, value);
}

PMDCFunc PMDGetDriveCommandMode       (PMDAxisInterface axis_intf, PMDuint8* transport, PMDuint8* format)
{
	PMDresult result;
	PMDuint16 value;

	result = SendCommandGetWord(axis_intf, PMDOPGetDriveCommandMode, &value);

	*transport = (PMDuint8)(value >> 8);
	*format = (PMDuint8)(value);
